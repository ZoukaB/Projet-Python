...
GRID_COLUMNS =1+ (SCREEN_WIDTH + CELL_SIZE ) // CELL_SIZE  # Round up to cover full width
GRID_ROWS =1+ (SCREEN_HEIGHT + CELL_SIZE) // CELL_SIZE   # Round up to cover full height
